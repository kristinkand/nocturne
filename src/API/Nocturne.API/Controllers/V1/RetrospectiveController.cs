...
public class RetrospectiveController : ControllerBase
{
    ...
    [HttpGet("at")]
    [NightscoutEndpoint("/api/v1/retrospective/at")]
    ...
    /// <response code="500">If there was an internal server error</response>
    [HttpGet("timeline")]
    [NightscoutEndpoint("/api/v1/retrospective/timeline")]
    ...
    [NightscoutEndpoint("/api/v1/retrospective/basal-timeline")]
