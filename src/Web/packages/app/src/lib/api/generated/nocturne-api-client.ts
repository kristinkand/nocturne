...
export class Client {
  ...
  getScalar(signal?: AbortSignal): Promise<void> {
    let url_ = this.baseUrl + "/scalar";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processGetScalar(_response);
    });
  }

  protected processGetScalar(response: Response): Promise<void> {
  ...
  getSwagger(signal?: AbortSignal): Promise<void> {
    let url_ = this.baseUrl + "/swagger";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processGetSwagger(_response);
    });
  }

  protected processGetSwagger(response: Response): Promise<void> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
...
export class AnalyticsClient {
   ...
   *
   * @returns Analytics configuration and collection status
   */
  ...
  protected processGetAnalyticsStatus(
    response: Response
  ...
  protected processGetPerformanceMetrics(
    response: Response
  ...
  protected processGetUsageStatistics(
    response: Response
   ...
   *
   * @returns Pending analytics data or null if none
   */
  ...
  protected processGetPendingAnalyticsData(
    response: Response
  ...
  updateAnalyticsConfig(
    ...
    signal?: AbortSignal
  ): Promise<AnalyticsCollectionConfig> {
  ...
  protected processUpdateAnalyticsConfig(
    response: Response
  ): Promise<AnalyticsCollectionConfig> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processClearAnalyticsData(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  /**
   * Force immediate transmission of pending analytics data
   *
   * @returns Confirmation message
   */
  flushAnalyticsData(signal?: AbortSignal): Promise<FileResponse> {
    let url_ = this.baseUrl + "/api/Analytics/flush";
    url_ = url_.replace(/[?&]$/, "");
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processFlushAnalyticsData(_response);
    });
  }

  protected processFlushAnalyticsData(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
   ...
   *
   * @returns Privacy and data collection information
   */
  ...
  protected processGetPrivacyInformation(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class AuthenticationClient {
  ...
  /**
   * Verify authentication status and permissions for the current request This
   * endpoint provides 1:1 compatibility with Nightscout's /api/v1/verifyauth
   * endpoint
   *
   * @returns Authentication status and permission information
   */
  ...
  protected processVerifyAuthentication(
    response: Response
...
export class AuthorizationClient {
  ...
  protected processGenerateJwtFromAccessToken(
    response: Response
  ): Promise<AuthorizationResponse> {
    const status = response.status;
    let _headers: any = {};
   ...
   *
   * @returns List of permissions with usage statistics
   */
   ...
   *
   * @returns Permission trie structure
   */
  ...
  protected processGetPermissionTrie(
    response: Response
  ): Promise<PermissionTrieResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as Subject[]);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as Role[]);
        return result200;
      });
    } else if (status === 401) {
      return response.text().then((_responseText) => {
...
export class MetadataClient {
  ...
  /**
   * Get WebSocket event types metadata This endpoint exists primarily to ensure
   * NSwag generates TypeScript types for WebSocket events
   *
   * @returns WebSocket events metadata
   */
  ...
  protected processGetWebSocketEvents(
    response: Response
  ): Promise<WebSocketEventsMetadata> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
...
export class StatisticsClient {
   ...
   * @returns Basic glucose statistics including mean, median, percentiles, etc.
   */
  calculateBasicStats(
    values: number[],
    signal?: AbortSignal
  ): Promise<BasicGlucoseStats> {
  ...
  protected processCalculateBasicStats(
    response: Response
  ): Promise<BasicGlucoseStats> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Comprehensive glycemic variability metrics
   */
  calculateGlycemicVariability(
    request: GlycemicVariabilityRequest,
    signal?: AbortSignal
  ...
  protected processCalculateGlycemicVariability(
    response: Response
  ): Promise<GlycemicVariability> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Time in range metrics including percentages, durations, and
   *   episodes
   */
  calculateTimeInRange(
    request: TimeInRangeRequest,
    signal?: AbortSignal
  ): Promise<TimeInRangeMetrics> {
  ...
  protected processCalculateTimeInRange(
    response: Response
  ): Promise<TimeInRangeMetrics> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Collection of distribution data points
   */
  calculateGlucoseDistribution(
    request: GlucoseDistributionRequest,
    signal?: AbortSignal
  ...
  protected processCalculateGlucoseDistribution(
    response: Response
  ): Promise<DistributionDataPoint[]> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Collection of averaged statistics for each hour
   */
  calculateAveragedStats(
    entries: Entry[],
    signal?: AbortSignal
  ): Promise<AveragedStats[]> {
  ...
  protected processCalculateAveragedStats(
    response: Response
  ): Promise<AveragedStats[]> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Treatment summary with totals and counts
   */
  ...
  protected processCalculateTreatmentSummary(
    response: Response
  ): Promise<TreatmentSummary> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Overall averages or null if no data
   */
  calculateOverallAverages(
    dailyDataPoints: DayData[],
    signal?: AbortSignal
  ): Promise<OverallAverages> {
  ...
  protected processCalculateOverallAverages(
    response: Response
  ): Promise<OverallAverages> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Comprehensive glucose analytics
   */
  analyzeGlucoseData(
    request: GlucoseAnalyticsRequest,
    signal?: AbortSignal
  ...
  protected processAnalyzeGlucoseData(
    response: Response
  ): Promise<GlucoseAnalytics> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Formatted insulin string
   */
   ...
   * @returns True if treatment data is valid
   */
   ...
   * @returns Cleaned collection of treatments
   */
  cleanTreatmentData(
    treatments: Treatment[],
    signal?: AbortSignal
  ...
  protected processCleanTreatmentData(
    response: Response
  ): Promise<Treatment[]> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as Treatment[]);
        return result200;
      });
    } else if (status !== 200 && status !== 204) {
      return response.text().then((_responseText) => {
  ...
  /**
   * Get comprehensive statistics for multiple time periods (1, 3, 7, 30, 90
   * days) Uses Redis cache for performance with daily expiration
   *
   * @returns Multi-period statistics with comprehensive analytics for each time
   *   period
   */
  getMultiPeriodStatistics(
    signal?: AbortSignal
  ): Promise<MultiPeriodStatistics> {
  ...
  protected processGetMultiPeriodStatistics(
    response: Response
  ): Promise<MultiPeriodStatistics> {
    const status = response.status;
    let _headers: any = {};
...
export class DeviceStatusClient {
  ...
  /**
   * Get device status records with V3 API features including pagination, field
   * selection, and advanced filtering
   *
   * @returns V3 device status collection response
   */
  ...
  protected processGetDeviceStatus(
    response: Response
  ): Promise<V3CollectionResponseOfObject> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
        ...
        result200 =
          _responseText === ""
            ...
            : (JSON.parse(
                _responseText,
                this.jsonParseReviver
              ) as V3CollectionResponseOfObject);
        return result200;
      });
    } else if (status === 400) {
      return response.text().then((_responseText) => {
   ...
   *
   * @param deviceStatusData Device status data to create (single object or
   *   array)
   * @returns Created device status records
   */
  createDeviceStatus(
  ...
  protected processCreateDeviceStatus(
    response: Response
  ): Promise<DeviceStatus[]> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Single device status record in V3 format
   */
  ...
  protected processGetDeviceStatusById(
    response: Response
  ): Promise<DeviceStatus> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Updated device status record
   */
  updateDeviceStatus(
    id: string,
  ...
  protected processUpdateDeviceStatus(
    response: Response
  ): Promise<DeviceStatus> {
    const status = response.status;
    let _headers: any = {};
   ...
   *
   * @param count (optional) Maximum number of device status entries to return
   *   (default: 10)
   * @param skip (optional) Number of device status entries to skip for
   *   pagination (default: 0)
   * @param format (optional) Output format: json (default), csv, tsv, or txt
   * @returns Array of device status entries ordered by most recent first
   */
  getDeviceStatus2(
  ...
  protected processGetDeviceStatus2(
    response: Response
  ): Promise<DeviceStatus[]> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Created device status entries with assigned IDs
   */
  createDeviceStatus2(
  ...
  protected processCreateDeviceStatus2(
    response: Response
  ): Promise<DeviceStatus[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processGetDeviceStatusJson(
    response: Response
  ): Promise<DeviceStatus[]> {
    const status = response.status;
    let _headers: any = {};
...
export class DiscrepancyClient {
   ...
   * @returns Compatibility metrics including success rate and response times
   */
  ...
  protected processGetCompatibilityMetrics(
    response: Response
  ): Promise<CompatibilityMetrics> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @param fromDate (optional) Start date for metrics (optional)
   * @param toDate (optional) End date for metrics (optional)
   * @returns List of endpoint-specific compatibility metrics
   */
  getEndpointMetrics(
    fromDate?: Date | null | undefined,
    toDate?: Date | null | undefined,
  ...
  protected processGetEndpointMetrics(
    response: Response
  ): Promise<EndpointMetrics[]> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @param count (optional) Number of results to return (default: 100, max:
   *   1000)
   * @param skip (optional) Number of results to skip for pagination (default:
   *   0)
   * @returns List of detailed discrepancy analyses
   */
  getDiscrepancyAnalyses(
    requestPath?: string | null | undefined,
    overallMatch?: number | null | undefined,
    fromDate?: Date | null | undefined,
    toDate?: Date | null | undefined,
    count?: number | undefined,
    skip?: number | undefined,
    signal?: AbortSignal
  ): Promise<DiscrepancyAnalysisDto[]> {
  ...
  protected processGetDiscrepancyAnalyses(
    response: Response
  ): Promise<DiscrepancyAnalysisDto[]> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Detailed discrepancy analysis
   */
  ...
  protected processGetDiscrepancyAnalysis(
    response: Response
  ): Promise<DiscrepancyAnalysisDto> {
    const status = response.status;
    let _headers: any = {};
   ...
   *
   * @returns Current compatibility status
   */
  ...
  protected processGetCompatibilityStatus(
    response: Response
   ...
   * @returns Text-based compatibility report
   */
  getTextReport(
    fromDate?: Date | null | undefined,
    toDate?: Date | null | undefined,
  ...
  getMigrationAssessment(
    ...
    let url_ =
      this.baseUrl + "/api/v3/Discrepancy/reports/migration-assessment?";
    if (fromDate !== undefined && fromDate !== null)
      url_ +=
        "fromDate=" +
        encodeURIComponent(fromDate ? "" + fromDate.toISOString() : "") +
  ...
  protected processGetMigrationAssessment(
    response: Response
  ): Promise<MigrationReadinessReport> {
    const status = response.status;
    let _headers: any = {};
...
export class EntriesClient {
  ...
  /**
   * Get entries with V3 API features including pagination, field selection, and
   * advanced filtering
   *
   * @returns V3 entries collection response
   */
    ...
    if (status === 201) {
      return response.text().then((_responseText) => {
        ...
        result201 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as Entry);
        return result201;
      });
    } else if (status === 400) {
      return response.text().then((_responseText) => {
   ...
   *
   * @param id Entry ID
   * @returns Single entry in V3 format
   */
  ...
  /**
   * Get the most recent glucose entry This endpoint assumes SGV (sensor glucose
   * value) type and returns the single most recent entry
   *
   * @returns The most recent glucose entry, or empty array if no entries exist
   */
   ...
   *
   * @param spec Either an entry ID (24-character hex string) or entry type
   *   (e.g., "sgv", "mbg", "cal")
   * @returns Entry or entries matching the specification
   */
  ...
  /**
   * Get entries with optional query parameters Supports advanced query features
   * including find filters, date ranges, and pagination
   *
   * @param find (optional) MongoDB-style find query filters (JSON format) - for
   *   unit tests
   * @param count (optional) Maximum number of entries to return (if not
  ...
  getEntries2(
    ...
    if (rr === null) throw new Error("The parameter 'rr' cannot be null.");
  ...
  /**
   * Create new entries Accepts both single entries and arrays of entries
   *
   * @param entryData Entry data to create (can be single entry or array)
   * @returns Created entries with assigned IDs
   */
  ...
  /**
   * Create new entries asynchronously Accepts both single entries and arrays of
   * entries, returns immediately with tracking information
   *
   * @param entryData Entry data to create (can be single entry or array)
   * @returns Async processing response with correlation ID and status URL
   */
  createEntries2(
    entryData: any,
    signal?: AbortSignal
  ): Promise<AsyncProcessingResponse> {
  ...
  protected processCreateEntries2(
    response: Response
  ): Promise<AsyncProcessingResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class FoodClient {
  ...
  /**
   * Get food records with V3 API features including pagination, field
   * selection, and advanced filtering
   *
   * @returns V3 food collection response
   */
    ...
    if (status === 201) {
      return response.text().then((_responseText) => {
        ...
        result201 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as Food[]);
        return result201;
      });
    } else if (status === 400) {
      return response.text().then((_responseText) => {
   ...
   *
   * @param id Food ID
   * @returns Single food record in V3 format
   */
   ...
   *
   * @returns Array of food records ordered by name/position
   */
   ...
   * @returns Created food records with assigned IDs
   */
   ...
   *
   * @returns Array of regular food records
   */
   ...
   *
   * @returns Array of quickpick food records ordered by position
   */
   ...
   * @returns The food record with the specified ID
   */
...
export class LastModifiedClient {
   ...
   *
   * @returns Last modified timestamps for each collection
   */
  ...
  protected processGetLastModified(
    response: Response
...
export class ProfileClient {
  ...
  /**
   * Get profiles with V3 API features including pagination, field selection,
   * and advanced filtering
   *
   * @returns V3 profiles collection response
   */
    ...
    if (status === 201) {
      return response.text().then((_responseText) => {
        ...
        result201 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as Profile[]);
        return result201;
      });
    } else if (status === 400) {
      return response.text().then((_responseText) => {
   ...
   *
   * @param id Profile ID
   * @returns Single profile in V3 format
   */
   ...
   *
   * @returns The current active profile, or empty array if no profiles exist
   */
   ...
   * @returns The profile with the specified ID, or empty array if not found
   */
...
export class SettingsClient {
  ...
  /**
   * Get settings with V3 API features including pagination, field selection,
   * and advanced filtering Requires admin permissions as per legacy API v3
   * behavior
   *
   * @returns V3 settings collection response
   */
   ...
   * @returns Created settings records
   */
    ...
    if (status === 201) {
      return response.text().then((_responseText) => {
        ...
        result201 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as Settings[]);
        return result201;
      });
    } else if (status === 400) {
      return response.text().then((_responseText) => {
  ...
  /**
   * Get a specific settings record by ID with V3 format Requires admin
   * permissions as per legacy API v3 behavior
   *
   * @param id Settings ID
   * @returns Single settings record in V3 format
   */
  ...
  /**
   * Update a settings record by ID with V3 format Requires admin permissions as
   * per legacy API v3 behavior
   *
  ...
  /**
   * Delete a settings record by ID Requires admin permissions as per legacy API
   * v3 behavior
   *
...
export class StatusClient {
   ...
   *
   * @returns Extended system status information with permissions and
...
export class TreatmentsClient {
  ...
  /**
   * Get treatments with V3 API features including pagination, field selection,
   * and advanced filtering
   *
   * @returns V3 treatments collection response
   */
  ...
  protected processGetTreatments(
    response: Response
  ): Promise<V3CollectionResponseOfObject> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Single treatment in V3 format
   */
   ...
   * @returns Created treatments with assigned IDs
   */
  createTreatments2(
    treatments: any,
    signal?: AbortSignal
   ...
   *
   * @returns Number of treatments deleted
   */
...
export class DDataClient {
  ...
  /**
   * Get current DData structure Returns comprehensive data structure containing
   * SGVs, treatments, profiles, and device status
   *
   * @returns Returns the DData structure
   */
  ...
  /**
   * Get DData structure for a specific timestamp Returns data relevant to the
   * specified timestamp
   *
  ...
  protected processGetDDataAt(response: Response): Promise<DDataResponse> {
    ...
    if (status === 200) {
      ...
      return response.text().then((_responseText) => {
        ...
        return throwException(
          "If the timestamp parameter is invalid",
          status,
          _responseText,
          _headers,
          result400
  ...
  /**
   * Get raw DData structure (without recent status filtering) Returns the
   * complete DData structure without filtering recent device statuses
   *
   * @param timestamp (optional) Optional Unix timestamp in milliseconds or ISO
   *   date string
   * @returns Returns the raw DData structure
   */
  getRawDData(
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as DData);
        return result200;
      });
    } else if (status === 400) {
      return response.text().then((_responseText) => {
...
export class LoopClient {
  ...
  /**
   * Send Loop notification directly to iOS Loop app via APNS Implements the
   * legacy ctx.loop.sendNotification() functionality with 1:1 compatibility
   * This endpoint expects the exact data structure used by the legacy loop.js
   * implementation
   *
   * @param request Loop notification data and settings
   * @returns Loop notification sent successfully
   */
  sendLoopNotification(
    request: LoopSendRequest,
    signal?: AbortSignal
  ): Promise<LoopNotificationResponse> {
  ...
  protected processSendLoopNotification(
    response: Response
  ): Promise<LoopNotificationResponse> {
    const status = response.status;
    let _headers: any = {};
    ...
    if (status === 200) {
      ...
      return response.text().then((_responseText) => {
        ...
        return throwException(
          "Invalid Loop notification request",
          status,
          _responseText,
          _headers,
          result400
  ...
  /**
   * Get Loop service configuration status Provides debugging information about
   * Loop/APNS configuration
   *
   * @returns Configuration status retrieved successfully
   */
...
export class NotificationsClient {
  ...
  /**
   * Send Loop notification for iOS Loop app integration Implements the
   * /api/v2/notifications/loop endpoint from legacy notifications-v2.js
   *
   * @param request Loop notification request data
   * @returns Notification processed successfully
   */
  sendLoopNotification(
    request: LoopNotificationRequest,
    signal?: AbortSignal
  ): Promise<NotificationV2Response> {
  ...
  /**
   * Process a generic V2 notification Provides a generic endpoint for
   * processing various notification types
   *
  ...
  protected processProcessNotification(
    response: Response
  ): Promise<NotificationV2Response> {
    const status = response.status;
    let _headers: any = {};
  ...
  /**
   * Get current notification system status and configuration Provides
   * information about the notification system capabilities and status
   *
   * @returns Notification status retrieved successfully
   */
  ...
  /**
   * Acknowledge a notification alarm to silence it Implements the
   * /notifications/ack endpoint from legacy notifications.js
   *
   * @param request Acknowledgment request containing level, group, and silence
   *   time
   * @returns Notification acknowledged successfully
   */
  ackNotification(
  ...
  protected processAckNotification(
    response: Response
  ): Promise<NotificationAckResponse> {
    const status = response.status;
    let _headers: any = {};
   ...
   * Implements the /notifications/pushovercallback endpoint for Pushover
   * integration
   *
   * @param request Pushover callback request data from webhook
   * @returns Pushover callback processed successfully
   */
  pushoverCallback(
    request: PushoverCallbackRequest,
    signal?: AbortSignal
  ): Promise<NotificationAckResponse> {
  ...
  protected processPushoverCallback(
    response: Response
  ): Promise<NotificationAckResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  /**
   * Get all admin notifications with their counts and timestamps Implements the
   * /adminnotifies endpoint from legacy adminnotifies.js
   *
   * @returns Admin notifications retrieved successfully
   */
  ...
  protected processGetAdminNotifies(
    response: Response
  ): Promise<AdminNotifiesResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
   ...
   * Provides an endpoint for creating admin notifications (typically used
   * internally)
   *
   * @param notification Admin notification to add
   * @returns Admin notification added successfully
   */
  ...
  protected processAddAdminNotification(
    response: Response
  ): Promise<NotificationAckResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  /**
   * Clear all admin notifications Provides an endpoint for clearing all admin
   * notifications (typically used for maintenance)
   *
   * @returns Admin notifications cleared successfully
   */
  ...
  protected processClearAllAdminNotifications(
    response: Response
  ): Promise<NotificationAckResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  /**
   * Send a Pushover notification for testing or manual triggering Provides an
   * endpoint for sending Pushover notifications directly
   *
   * @param request Pushover notification request
   * @returns Pushover notification sent successfully
   */
  sendPushoverNotification(
    request: PushoverNotificationRequest,
    signal?: AbortSignal
  ): Promise<NotificationAckResponse> {
  ...
  protected processSendPushoverNotification(
    response: Response
  ): Promise<NotificationAckResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class PropertiesClient {
  ...
  /**
   * Get all client properties and settings Returns comprehensive properties
   * structure containing plugin data, settings, and computed values
   *
   * @param pretty (optional) Format JSON with indentation for readability
   * @returns Returns the properties structure
   */
  getAllProperties(
  ...
  protected processGetAllProperties(
    response: Response
  ): Promise<{ [key: string]: any }> {
    const status = response.status;
    let _headers: any = {};
  ...
  /**
   * Get specific properties by names (comma-separated) Supports paths like
   * /prop1 or /prop1,prop3 to get only specific properties
   *
   * @param propertyPath Comma-separated list of property names to retrieve
   * @param pretty (optional) Format JSON with indentation for readability
   * @returns Returns the selected properties
   */
  getSpecificProperties(
    ...
    url_ = url_.replace(
      "{propertyPath}",
      encodeURIComponent("" + propertyPath)
    );
    if (pretty === null)
      throw new Error("The parameter 'pretty' cannot be null.");
    else if (pretty !== undefined)
  ...
  protected processGetSpecificProperties(
    response: Response
  ): Promise<{ [key: string]: any }> {
    const status = response.status;
    let _headers: any = {};
...
export class SummaryClient {
  ...
  /**
   * Get summary data for the specified time window Returns processed SGVs,
   * treatments, profile, and state information
   *
   * @param hours (optional) Number of hours to include in summary (default 6)
   * @returns Returns the summary data
   */
  getSummary(
  ...
  protected processGetSummary(response: Response): Promise<SummaryResponse> {
    ...
    if (status === 200) {
      ...
      return response.text().then((_responseText) => {
        ...
        return throwException(
          "If the hours parameter is invalid",
          status,
          _responseText,
          _headers,
          result400
...
export class ActivityClient {
   ...
   *
   * @param count (optional) Maximum number of activities to return (default:
   *   10)
   * @param skip (optional) Number of activities to skip for pagination
   *   (default: 0)
   * @returns Activities retrieved successfully
   */
  getActivities(
    count?: number | undefined,
    skip?: number | undefined,
   ...
   * @returns Activities created successfully
   */
   ...
   * @returns Activity found and returned
   */
   ...
   * @returns Activity updated successfully
   */
  updateActivity(
    id: string,
    activity: Activity,
   ...
   * @returns Activity deleted successfully
   */
...
export class AlexaClient {
  ...
  /**
   * Handle Alexa Skills Kit requests for voice assistant integration Processes
   * LaunchRequest, IntentRequest, and SessionEndedRequest types Maintains
   * complete compatibility with legacy /api/alexa endpoint
   *
   * @param request Alexa Skills Kit request from Amazon
   * @returns Alexa response with speech output and session handling
   */
  handleAlexaRequest(
  ...
  protected processHandleAlexaRequest(
    response: Response
  ): Promise<AlexaResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class CountClient {
   ...
   * @returns Count of entries matching the criteria
   */
  countEntries(
    find?: string | null | undefined,
    type?: string | null | undefined,
   ...
   *
   * @param find (optional) MongoDB-style find query filters (JSON format)
   * @returns Count of treatments matching the criteria
   */
  countTreatments(
    find?: string | null | undefined,
    signal?: AbortSignal
   ...
   *
   * @param find (optional) MongoDB-style find query filters (JSON format)
   * @returns Count of device status entries matching the criteria
   */
  countDeviceStatus(
    find?: string | null | undefined,
    signal?: AbortSignal
  ...
  protected processCountDeviceStatus(
    response: Response
  ): Promise<CountResponse> {
    const status = response.status;
    let _headers: any = {};
   ...
   *
   * @param find (optional) MongoDB-style find query filters (JSON format)
   * @returns Count of activity entries matching the criteria
   */
  countActivity(
    find?: string | null | undefined,
    signal?: AbortSignal
   ...
   *
   * @param storage Storage type (entries, treatments, devicestatus, profile,
   *   food, activity)
   * @param find (optional) MongoDB-style find query filters (JSON format)
...
export class DebugClient {
  ...
  protected processTestPostgreSqlConnection(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class DeviceAgeClient {
   ...
   * @returns Cannula age information
   */
  getCannulaAge(
    info?: number | null | undefined,
    warn?: number | null | undefined,
    urgent?: number | null | undefined,
    display?: string | null | undefined,
    enableAlerts?: boolean | null | undefined,
    signal?: AbortSignal
  ): Promise<DeviceAgeInfo> {
  ...
  /**
   * Get sensor age information based on sensor start and sensor change
   * treatments
   *
   ...
   * @param enableAlerts (optional) Enable alert notifications (default: false)
   * @returns Sensor age information
   */
  getSensorAge(
    info?: number | null | undefined,
    warn?: number | null | undefined,
   ...
   * @param display (optional) Display format: hours or days (default: days)
   * @param enableAlerts (optional) Enable alert notifications (default: false)
   * @returns Battery age information
   */
  getBatteryAge(
    info?: number | null | undefined,
    warn?: number | null | undefined,
  ...
  /**
   * Get calibration age information based on BG Check and Calibration
   * treatments
   *
   ...
   * @param display (optional) Display format: hours or days (default: hours)
   * @param enableAlerts (optional) Enable alert notifications (default: false)
   * @returns Calibration age information
   */
  getCalibrationAge(
    info?: number | null | undefined,
    warn?: number | null | undefined,
  ...
  protected processGetCalibrationAge(
    response: Response
  ): Promise<DeviceAgeInfo> {
    const status = response.status;
    let _headers: any = {};
   ...
   *
   * @returns Combined device age information
   */
...
export class DeviceAlertsClient {
   ...
   * @returns List of active device alerts
   */
  getActiveDeviceAlerts(
  ...
  protected processGetActiveDeviceAlerts(
    response: Response
  ): Promise<DeviceAlert[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processGetDeviceAlertSummary(
    response: Response
  ): Promise<DeviceAlertSummary> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  protected processAcknowledgeDeviceAlert(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processTestDeviceAlerts(
    response: Response
  ): Promise<DeviceAlert[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processGetAlertSettings(
    response: Response
  ): Promise<DeviceAlertSettings> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  protected processUpdateAlertSettings(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class DeviceHealthClient {
  ...
  protected processGetDeviceHealth(
    response: Response
  ): Promise<DeviceHealthAnalysis> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processUpdateDeviceHealth(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processUpdateDeviceSettings(
    response: Response
  ): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processGetDeviceHealthReport(
    response: Response
  ): Promise<DeviceHealthReport> {
    const status = response.status;
    let _headers: any = {};
  ...
  protected processGetMaintenancePrediction(
    response: Response
  ): Promise<MaintenancePrediction> {
    const status = response.status;
    let _headers: any = {};
...
export class EchoClient {
  ...
  /**
   * Echo endpoint for debugging MongoDB queries Returns information about how
   * REST API parameters translate into MongoDB queries
   *
   * @param echo Storage type to query (entries, treatments, devicestatus,
   *   activity)
   * @returns Query information returned successfully
   */
  ...
  /**
   * Echo endpoint for debugging MongoDB queries with model Returns information
   * about how REST API parameters translate into MongoDB queries
   *
   * @param echo Storage type to query (entries, treatments, devicestatus,
   *   activity)
  ...
  /**
   * Echo endpoint for debugging MongoDB queries with model and spec Returns
   * information about how REST API parameters translate into MongoDB queries
   *
   * @param echo Storage type to query (entries, treatments, devicestatus,
   *   activity)
   * @param model Model specification
  ...
  /**
   * Preview endpoint for entry creation without persistence Allows previewing
   * entry data without actually storing it in the database
   *
   * @param entries Entry data to preview (single object or array)
   * @returns Entry data previewed successfully
   */
...
export class IobClient {
   ...
   *
   * @param time (optional) Optional timestamp for calculation (default: current
   *   time)
   * @returns Returns the current IOB calculation
   */
  getCurrentIob(
    ...
    if (status === 200) {
      return response.text().then((_responseText) => {
        ...
        result200 =
          _responseText === ""
            ? null
            : (JSON.parse(_responseText, this.jsonParseReviver) as IobResult);
        return result200;
      });
    } else if (status === 500) {
      return response.text().then((_responseText) => {
   ...
   * @param time (optional) Optional timestamp for calculation (default: current
   *   time)
   * @returns Returns the IOB calculation from treatments
   */
  getIobFromTreatments(
    time?: number | null | undefined,
    signal?: AbortSignal
  ): Promise<IobResult> {
  ...
  protected processGetIobFromTreatments(
    response: Response
  ): Promise<IobResult> {
    const status = response.status;
    let _headers: any = {};
   ...
   *
   * @param intervalMinutes (optional) Time interval in minutes for calculations
   *   (default: 5)
   * @param hours (optional) Number of hours to calculate (default: 24)
   * @param startTime (optional) Start time for calculation (default: 24 hours
   *   ago)
   * @returns Returns the hourly IOB breakdown
   */
  getHourlyIob(
    ...
    if (intervalMinutes === null)
      ...
      url_ +=
        "intervalMinutes=" + encodeURIComponent("" + intervalMinutes) + "&";
    if (hours === null)
...
export class ProcessingClient {
   ...
   * @returns Processing status or 404 if not found
   */
  getProcessingStatus(
  ...
  protected processGetProcessingStatus(
    response: Response
  ): Promise<ProcessingStatusResponse> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @param timeoutSeconds (optional) Maximum time to wait in seconds (default:
   *   30)
   * @returns Processing status when completed or timeout response
   */
  waitForCompletion(
    correlationId: string,
  ...
  protected processWaitForCompletion(
    response: Response
  ): Promise<ProcessingStatusResponse> {
    const status = response.status;
    let _headers: any = {};
...
export class TimeQueryClient {
   ...
   * @param format (optional) Output format (json, csv, tsv, txt)
   * @returns Entries matching the time patterns
   */
  getTimeBasedEntries(
    count?: number | undefined,
    format?: string | null | undefined,
  ...
  protected processGetTimeBasedEntriesWithPrefix(
    response: Response
  ): Promise<Entry[]> {
    const status = response.status;
    let _headers: any = {};
   ...
   * @returns Entries matching the time patterns
   */
  getTimeBasedEntriesWithPrefixAndRegex(
    prefix: string,
    regex: string,
    count?: number | undefined,
    format?: string | null | undefined,
  ...
  protected processGetTimeBasedEntriesWithPrefixAndRegex(
    response: Response
  ): Promise<Entry[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  /**
   * Time query debugging and pattern inspection Shows how the time patterns are
   * expanded and what MongoDB query would be generated
   *
   ...
   * @returns Debug information about the generated patterns and query
   */
  getTimeQueryEcho(
    storage?: string | undefined,
    field?: string | undefined,
    signal?: AbortSignal
  ): Promise<TimeQueryEcho> {
  ...
  protected processGetTimeQueryEcho(
    response: Response
  ): Promise<TimeQueryEcho> {
    const status = response.status;
    let _headers: any = {};
  ...
  /**
   * Time query debugging and pattern inspection with prefix Shows how the time
   * patterns are expanded and what MongoDB query would be generated
   *
  ...
  protected processGetTimeQueryEchoWithPrefix(
    response: Response
  ): Promise<TimeQueryEcho> {
    const status = response.status;
    let _headers: any = {};
  ...
  /**
   * Time query debugging and pattern inspection with prefix and regex Shows how
   * the time patterns are expanded and what MongoDB query would be generated
   *
   * @param prefix Time prefix pattern
   ...
   * @returns Debug information about the generated patterns and query
   */
  getTimeQueryEchoWithPrefixAndRegex(
    prefix: string,
    regex: string,
    storage?: string | undefined,
    field?: string | undefined,
  ...
  protected processGetTimeQueryEchoWithPrefixAndRegex(
    response: Response
  ): Promise<TimeQueryEcho> {
    const status = response.status;
    let _headers: any = {};
  ...
  /**
   * Advanced data slicing with regex patterns and field filtering Allows
   * specifying storage layer, field to match, entry type, and pattern matching
   *
   ...
   *   /api/v1/slice/treatments/created_at/bolus/2015-04 - All bolus treatments
   *   from April 2015
   *
   ...
   * @param count (optional) Maximum number of entries to return (default: 10)
   * @param format (optional) Output format (json, csv, tsv, txt)
   * @returns Entries matching the slice criteria
   */
  getSlicedData(
    storage: string,
    field: string,
   ...
   * @returns Entries matching the slice criteria
   */
  getSlicedDataWithTypeAndPrefix(
    storage: string,
    field: string,
    type: string,
    prefix: string,
    ...
    let url_ =
      this.baseUrl + "/api/v1/slice/{storage}/{field}/{type}/{prefix}?";
    if (storage === undefined || storage === null)
      throw new Error("The parameter 'storage' must be defined.");
    url_ = url_.replace("{storage}", encodeURIComponent("" + storage));
    if (field === undefined || field === null)
  ...
  protected processGetSlicedDataWithTypeAndPrefix(
    response: Response
  ): Promise<Entry[]> {
    const status = response.status;
    let _headers: any = {};
  ...
  getSlicedDataWithAll(
    ...
    let url_ =
      this.baseUrl + "/api/v1/slice/{storage}/{field}/{type}/{prefix}/{regex}?";
    if (storage === undefined || storage === null)
      throw new Error("The parameter 'storage' must be defined.");
    url_ = url_.replace("{storage}", encodeURIComponent("" + storage));
    if (field === undefined || field === null)
...
export class CompatibilityProxyClient {
  private http: {
    fetch(url: RequestInfo, init?: RequestInit): Promise<Response>;
  };
  private baseUrl: string;
  ...
  /** Handle GET requests */
  get(path: string, signal?: AbortSignal): Promise<FileResponse> {
  ...
  post(path: string, signal?: AbortSignal): Promise<FileResponse> {
    let url_ = this.baseUrl + "/{path}";
    if (path === undefined || path === null)
      throw new Error("The parameter 'path' must be defined.");
    url_ = url_.replace("{path}", encodeURIComponent("" + path));
  ...
  /** Handle PUT requests */
  put(path: string, signal?: AbortSignal): Promise<FileResponse> {
    let url_ = this.baseUrl + "/{path}";
    if (path === undefined || path === null)
      throw new Error("The parameter 'path' must be defined.");
    url_ = url_.replace("{path}", encodeURIComponent("" + path));
  ...
  delete(path: string, signal?: AbortSignal): Promise<FileResponse> {
    let url_ = this.baseUrl + "/{path}";
    if (path === undefined || path === null)
      throw new Error("The parameter 'path' must be defined.");
    url_ = url_.replace("{path}", encodeURIComponent("" + path));
  ...
  patch(path: string, signal?: AbortSignal): Promise<FileResponse> {
    let url_ = this.baseUrl + "/{path}";
    if (path === undefined || path === null)
      throw new Error("The parameter 'path' must be defined.");
    url_ = url_.replace("{path}", encodeURIComponent("" + path));
  ...
  protected processPatch(response: Response): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  head(path: string, signal?: AbortSignal): Promise<FileResponse> {
    let url_ = this.baseUrl + "/{path}";
    if (path === undefined || path === null)
      throw new Error("The parameter 'path' must be defined.");
    url_ = url_.replace("{path}", encodeURIComponent("" + path));
    ...
    return this.http.fetch(url_, options_).then((_response: Response) => {
      return this.processHead(_response);
    });
  }

  protected processHead(response: Response): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
  ...
  options(path: string, signal?: AbortSignal): Promise<FileResponse> {
    let url_ = this.baseUrl + "/{path}";
    if (path === undefined || path === null)
      throw new Error("The parameter 'path' must be defined.");
    url_ = url_.replace("{path}", encodeURIComponent("" + path));
  ...
  protected processOptions(response: Response): Promise<FileResponse> {
    const status = response.status;
    let _headers: any = {};
    if (response.headers && response.headers.forEach) {
      response.headers.forEach((v: any, k: any) => (_headers[k] = v));
...
/**
 * Loop notification request model for the direct Loop endpoint Combines the
 * data and loopSettings for a complete notification request
 */
...
export function isProcessingStatusResponse(
  object: any
): object is ProcessingStatusResponse {
