...
public class ActivityControllerTests
{
    ...
    public async Task GetActivities_WithCustomParameters_ShouldPassParametersToService()
    {
        ...
        _mockStateSpanService
            .Setup(x => x.GetActivitiesAsync(It.IsAny<string?>(), count, skip, It.IsAny<CancellationToken>()))
            .ReturnsAsync(expectedActivities);
        ...
        _mockStateSpanService.Verify(
            x => x.GetActivitiesAsync(It.IsAny<string?>(), count, skip, It.IsAny<CancellationToken>()),
            Times.Once
        );
    }
